...
export default function RegisterPage() {
	...
	return (
		<div className="centered-container-form centered-container-form-width">
			...
			<input type="email" className="form-box-size form-rounded-box" type="text" name="email" placeholder="Электронная почта" onChange={handleChange} />
			...
			<input type="password" className="form-box-size form-rounded-box" type="text" name="password" placeholder="Пароль" onChange={handleChange} />
			<input type="password" className="form-box-size form-rounded-box" type="text" name="confirmPassword" placeholder="Повторите пароль" onChange={handleChange} />
