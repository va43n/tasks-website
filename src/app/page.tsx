    ...
    return (
        <div className="centered-container-start centered-container-start-width">
            ...
            <div className="pic-text-container">
                ...
                <Image src="https://asooxovwhivjltdaiozk.supabase.co/storage/v1/object/public/start-page-files//1.jpg" className="landscape-img-size" />
            </div>
            <div className="pic-text-container">
                <Image src="https://asooxovwhivjltdaiozk.supabase.co/storage/v1/object/public/start-page-files//3.jpg" className="landscape-img-size" />
                <div>
            ...
            <div className="pic-text-container">
                ...
                <Image src="https://asooxovwhivjltdaiozk.supabase.co/storage/v1/object/public/start-page-files//4.2.png" className="landscape-img-size" />
            </div>
        </div>
    );
}
